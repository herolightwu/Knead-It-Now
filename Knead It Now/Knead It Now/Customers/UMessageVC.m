...
- (void)viewDidLoad {
    ...
    if([self.fromphoto length] > 0){
        ...
        m_toAvatar = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"ic_therapist.png"]
                                                                diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
    }
    ...
    if([g_user.photo length] > 0){
        ...
        m_fromAvatar = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"ic_user.png"]
                                                                  diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
    }
...
- (void)loadMessages{
    ...
    [HttpApi getMessages:self.bookid Success:^(NSDictionary* result){
        ...
        self.fromname = result[@"seller_name"];
